...
#define LED_3          NRF_GPIO_PIN_MAP(1,7)
...
#define RX_PIN_NUMBER 8 //NRF_GPIO_PIN_MAP(0,31)
#define TX_PIN_NUMBER 6 // NRF_GPIO_PIN_MAP(0,4)
...
#define BOOT_PIN		    NRF_GPIO_PIN_MAP(0,27)    // SPI SCK signal.
